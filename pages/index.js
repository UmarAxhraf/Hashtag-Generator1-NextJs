...
export default function Home() {
  ...
  return (
    <div className="flex flex-col md:px-12 px-4 bg-background font-poppins items-center justify-center min-h-screen">
      <h1 className="md:text-6xl text-4xl font-bold text-center text-active">
        Hashtag Generator
      </h1>
      <h2 className="text-primary text-center text-2xl font-light mt-6">
        Search a word for best hashtags.
      </h2>
      <form
      ...
      >
        <input
          ...
          placeholder="Enter your keyword eg: food"
          onChange={(e) => {
        ...
        <div className="mt-4 sm:mt-0 sm:ml-3">
          <button
            className="w-full rounded-lg px-5 py-3 bg-active1 font-bold text-lg text-active hover:bg-primary sm:px-10"
            type="submit"
          >
            {loading ? (
      ...
      <div className="mt-20 opacity-70 text-center">
        <p className="text-primary text-xs">
          Copyright © 2022 -{" "}
          <a className="hover:text-active" href="https://github.com/UmarAxhraf">
            @Umar Ashraf
          </a>
        </p>
      </div>
